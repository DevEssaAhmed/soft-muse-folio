...
const BlogEditorEnhanced: React.FC = () => {
 ...
 const [formData, setFormData] = useState<{
  ...
  series_id: null,      // Added series support
 ...
 const fetchBlogPost = async () => {
  ...
  try {
   ...
   setFormData({
    ...
    category_name: '',
    series_id: data.series_id || null,       // Load series data
         ...
         <div>
          ...
          <div className="flex gap-2 mt-1">
           <Select
            ...
            onValueChange={(value) => setFormData(prev => ({ ...prev, series_id: value === 'none' ? null : value }))}
           >
            <SelectTrigger>
